...
echo "🚀 Preparing SharePoint to Dropbox Video Bridge for DreamHost deployment..."
...
echo "   ssh username@yourserver.dreamhost.com"
echo ""
echo "2. Navigate to your web directory:"
echo "   cd /home/username/yourdomain.com"
echo ""
